...
//@Configuration
//使用Spring Data JPA
//@EnableJpaRepositories(basePackages = "springdemo.springmvc.com.zhenghao.repository.springdata.jpa")
public class JpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource, JpaVendorAdapter adapter) {
        ...
        entityManagerFactoryBean.setPackagesToScan(new String[]{"springdemo.springmvc.com.zhenghao.domain"});
